...
$headers[] = 'X-Location: -6.405821,106.064193';
    ...
    echo "[+]Process Redeem GOFOODSANTAI19\n";
				...
				$claim = curl('https://api.gojekapi.com/go-promotions/v1/promotions/enrollments', $data4, $headers);
				$claims = json_decode($claim[0]);
					echo $claims->data->message;
					echo "\n";
					echo "Tunggu 10 Detik!\n";
				...
				$claim = curl('https://api.gojekapi.com/go-promotions/v1/promotions/enrollments', $data5, $headers);
				$claims = json_decode($claim[0]);
					echo $claims->data->message;
					echo "\n";
					echo "Tunggu 10 Detik!\n";
